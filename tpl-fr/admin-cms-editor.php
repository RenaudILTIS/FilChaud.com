<div class="container row">
    <h2>Admin -- CMS Page editor</h2>
    <form action="admin-cms.php?action=<?php echo ($action == 'add')? 'add':'edit&id='.$cmsContent['id']; ?>" method="post">
        <input type="text" name="name" class="form-control" placeholder="Name of the page" <?php echo ($action == 'edit')? 'value="'.$cmsPage['name'].'"':''; ?>>
        <div class="controls">
            <div id="toolbar" style="display: none;">
                <span class="dropdown">
                    <a href="#" data-toggle="dropdown" class="btn btn-default btn-small dropdown-toggle"><i class=" glyphicon glyphicon-font toolbar-icon"></i> <span class="current-font">Text</span> <b class="caret"></b></a>
                    <ul class="dropdown-menu" id="font-change">
                        ...
                        <li><a data-wysihtml5-command-value="h1" data-wysihtml5-command="formatBlock" href="#" >Large title</a></li>
                ...
                <span class="dropdown">
                    <a href="#" data-toggle="dropdown" class="btn dropdown-toggle btn-default btn-small"><i class="glyphicon glyphicon-tint" id="color-tint"></i> <span class="current-color">Black</span> <b class="caret"></b></a>
                ...
                <div class="btn-group">
                    <a data-wysihtml5-command="bold" class="btn btn-default btn-default btn-small" href="#" title="Bold"><i class="glyphicon glyphicon-bold"></i></a>
                    <a data-wysihtml5-command="italic" class="btn btn-default btn-default btn-small" href="#" title="Italic"><i class="glyphicon glyphicon-italic"></i></a>
                    <a data-wysihtml5-command="underline" class="btn btn-default btn-default btn-small" href="#" title="Underline"><i class="glyphicon glyphicon-text-width"></i></a>
                </div>
                <div class="btn-group">
                    <a title="Unordered list" data-wysihtml5-command="insertUnorderedList" class="btn btn-default btn-small" href="#" ><i class="glyphicon glyphicon-list"></i></a>
                    <a title="Ordered list" data-wysihtml5-command="insertOrderedList" class="btn btn-default btn-small" href="#" ><i class="glyphicon glyphicon-th-list"></i></a>
                    <a title="Indent" data-wysihtml5-command="Indent" class="btn btn-default btn-small" href="#" ><i class="glyphicon glyphicon-indent-left"></i></a>
                    <a title="Outdent" data-wysihtml5-command="Outdent" class="btn btn-default btn-small" href="#" ><i class="glyphicon glyphicon-indent-right"></i></a>
                </div>

                <a title="Insert link" data-wysihtml5-command="createLink" class="btn btn-default btn-small" href="#" ><i class="glyphicon glyphicon-link"></i></a>
                <a title="Insert image" data-wysihtml5-command="insertImage" class="btn btn-default btn-small" href="#" ><i class="glyphicon glyphicon-picture"></i></a>
                <a title="Text/HTML view" data-wysihtml5-action="change_view" class="btn btn-default btn-small" href="#" ><i class="glyphicon glyphicon-retweet"></i></a>
            ...
            <textarea rows="20" name="content" id="article-content" placeholder="Your page here" class="col-md-10 form-control"><?php echo ($action == 'edit')? $cmsContent['content']:''; ?></textarea>
