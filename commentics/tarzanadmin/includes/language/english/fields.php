...
define('CMTX_FIELD_LABEL_PAGE_NUMBER', 'Page No:');
...
define('CMTX_FIELD_LABEL_SORT_BY_3', 'Likes:');
define('CMTX_FIELD_LABEL_SORT_BY_4', 'Dislikes:');
...
define('CMTX_FIELD_LABEL_GRAVATAR_SIZE', 'Size:');
...
define('CMTX_FIELD_LABEL_RECAPTCHA_PUBLIC_KEY', 'Public Key:');
define('CMTX_FIELD_LABEL_RECAPTCHA_PRIVATE_KEY', 'Private Key:');
define('CMTX_FIELD_LABEL_RECAPTCHA_THEME', 'Theme:');
define('CMTX_FIELD_LABEL_RECAPTCHA_LANGUAGE', 'Language:');
...
define('CMTX_FIELD_VALUE_SUBSCRIBER', 'email subscriber');
define('CMTX_FIELD_VALUE_SUBSCRIBERS', 'email subscribers');
...
define('CMTX_FIELD_VALUE_SORT_BY_1', 'Newest');
define('CMTX_FIELD_VALUE_SORT_BY_2', 'Oldest');
define('CMTX_FIELD_VALUE_SORT_BY_3', 'Likes');
define('CMTX_FIELD_VALUE_SORT_BY_4', 'Dislikes');
define('CMTX_FIELD_VALUE_SORT_BY_5', 'Positive');
define('CMTX_FIELD_VALUE_SORT_BY_6', 'Critical');
...
define('CMTX_FIELD_VALUE_REJECT', 'Error');
...
define('CMTX_FIELD_VALUE_SPAM_DELETE_THIS', 'Delete this.');
define('CMTX_FIELD_VALUE_SPAM_DELETE_ALL', 'Delete all by this user.');
define('CMTX_FIELD_VALUE_SPAM_DO_BAN', 'Ban.');
define('CMTX_FIELD_VALUE_SPAM_NO_BAN', 'Don\'t ban.');
define('CMTX_FIELD_VALUE_SPAM_NAME', 'Add name, <b>%s</b>, to banned names list.');
define('CMTX_FIELD_VALUE_SPAM_EMAIL', 'Add email, <b>%s</b>, to banned emails list.');
define('CMTX_FIELD_VALUE_SPAM_WEBSITE', 'Add website, <b>%s</b>, to banned websites list.');
...
define('CMTX_FIELD_VALUE_FOUND_AT', 'Found at line <b>%d</b> in the file');
define('CMTX_FIELD_VALUE_NOT_FOUND', 'Not Found');
define('CMTX_FIELD_VALUE_DELAY_PAGES', 'Don\'t create the page until the user posts.');
