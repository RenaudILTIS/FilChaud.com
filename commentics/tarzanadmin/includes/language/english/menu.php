...
define('CMTX_MENU_LAYOUT_COMMENTS_READ_MORE', 'Read More');
...
define('CMTX_MENU_LAYOUT_FORM_ORDER', 'Order');
...
define('CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_USER_SUBSCRIBER_NOTIFICATION_ADMIN', 'Subscriber Notify (Admin)');
define('CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_USER_SUBSCRIBER_NOTIFICATION_BASIC', 'Subscriber Notify (Basic)');
define('CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_USER_SUBSCRIBER_NOTIFICATION_REPLY', 'Subscriber Notify (Reply)');
