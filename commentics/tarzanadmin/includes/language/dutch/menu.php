...
define('CMTX_MENU_LAYOUT_COMMENTS_READ_MORE', 'Lees Meer');
...
define('CMTX_MENU_LAYOUT_FORM_ORDER', 'Volgorde');
...
define('CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_USER_SUBSCRIBER_NOTIFICATION_ADMIN', 'Inschrijver Notificatie (Admin)');
define('CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_USER_SUBSCRIBER_NOTIFICATION_BASIC', 'Inschrijver Notificatie (Basic)');
define('CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_USER_SUBSCRIBER_NOTIFICATION_REPLY', 'Inschrijver Notificatie (Reply)');
...
define('CMTX_MENU_TITLE_REPORT_VIEWERS', 'Viewers');
