...
define('CMTX_FIELD_LABEL_PAGE_NUMBER', 'Paginanummer:');
...
define('CMTX_FIELD_LABEL_RECAPTCHA_PUBLIC_KEY', 'Openbare Sleutel:');
define('CMTX_FIELD_LABEL_RECAPTCHA_PRIVATE_KEY', 'Privé Sleutel:');
define('CMTX_FIELD_LABEL_RECAPTCHA_THEME', 'Thema:');
define('CMTX_FIELD_LABEL_RECAPTCHA_LANGUAGE', 'Taal:');
...
define('CMTX_FIELD_VALUE_SUBSCRIBER', 'email inschrijver');
define('CMTX_FIELD_VALUE_SUBSCRIBERS', 'email inschrijvers');
...
define('CMTX_FIELD_VALUE_SORT_BY_1', 'Nieuwste');
define('CMTX_FIELD_VALUE_SORT_BY_2', 'Oudste');
define('CMTX_FIELD_VALUE_SORT_BY_3', 'Nuttig');
define('CMTX_FIELD_VALUE_SORT_BY_4', 'Nutteloos');
define('CMTX_FIELD_VALUE_SORT_BY_5', 'Positief');
define('CMTX_FIELD_VALUE_SORT_BY_6', 'Kritisch');
...
define('CMTX_FIELD_VALUE_REJECT', 'Fout');
...
define('CMTX_FIELD_VALUE_SPAM_DELETE_THIS', 'Verwijder deze.');
define('CMTX_FIELD_VALUE_SPAM_DELETE_ALL', 'Verwijder alle van deze gebruiker.');
define('CMTX_FIELD_VALUE_SPAM_DO_BAN', 'Verbieden.');
define('CMTX_FIELD_VALUE_SPAM_NO_BAN', 'Niet te verbieden.');
define('CMTX_FIELD_VALUE_SPAM_NAME', 'naam toevoegen, <b>%s</b>, tot verboden namenlijst.');
define('CMTX_FIELD_VALUE_SPAM_EMAIL', 'Voeg e-mail, <b>%s</b>, tot verboden e-mails lijst.');
define('CMTX_FIELD_VALUE_SPAM_WEBSITE', 'Voeg website, <b>%s</b>, tot verboden websites lijst.');
...
define('CMTX_FIELD_VALUE_FOUND_AT', 'Gevonden op regel <b>%d</b> in het bestand');
define('CMTX_FIELD_VALUE_NOT_FOUND', 'Niet Gevonden');
define('CMTX_FIELD_VALUE_DELAY_PAGES', 'Gebruik de pagina niet te maken totdat de gebruiker berichten.');
