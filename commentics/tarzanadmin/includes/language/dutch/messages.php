...
define('CMTX_MSG_SAVED', 'Instellingen opgeslagen.');
...
define('CMTX_MSG_ADMIN_SUPER_DELETE', 'De super admin kan niet worden verwijderd.');
...
define('CMTX_MSG_ADMIN_SUPER_ONLY', 'Sorry, alleen de super admin heeft toegang tot deze pagina.');
...
define('CMTX_MSG_LIST_UPDATED', 'Lijst aangepast.');
...
define('CMTX_MSG_NOTICE_MANAGE_COMMENTS', 'Om de prestaties te verbeteren, worden alleen de laatste 50 reacties getoond. Ga naar Settings -> System om dit te veranderen.');
...
define('CMTX_MSG_DEMO', 'Deze funtie is uitgeschakeld in demo.');
