...
define('CMTX_FIELD_LABEL_COOKIE', 'Cookie:');
...
define('CMTX_FIELD_LABEL_RSS', 'RSS:');
define('CMTX_FIELD_LABEL_PAGE_NUMBER', 'Página Número:');
define('CMTX_FIELD_LABEL_ORDER', 'Ordem:');
define('CMTX_FIELD_LABEL_DISPLAY_COMMENT_COUNT', 'Exibir Contar:');
...
define('CMTX_FIELD_LABEL_HIDE_FORM', 'Hide the Form:');
...
define('CMTX_FIELD_LABEL_RECAPTCHA_PUBLIC_KEY', 'Chave Pública:');
define('CMTX_FIELD_LABEL_RECAPTCHA_PRIVATE_KEY', 'Chave Privada:');
define('CMTX_FIELD_LABEL_RECAPTCHA_THEME', 'Tema:');
define('CMTX_FIELD_LABEL_RECAPTCHA_LANGUAGE', 'Idioma:');
...
define('CMTX_FIELD_LABEL_SITE_NAME', 'Site Name:');
define('CMTX_FIELD_LABEL_TIME_ZONE', 'Fuso Horário:');
define('CMTX_FIELD_LABEL_SITE_DOMAIN', 'Site Domain:');
define('CMTX_FIELD_LABEL_SITE_URL', 'Site URL:');
define('CMTX_FIELD_LABEL_COMMENTICS_FOLDER', 'Commentics Folder:');
define('CMTX_FIELD_LABEL_COMMENTICS_URL', 'Commentics URL:');
...
define('CMTX_FIELD_LABEL_TEXT', 'Text:');
define('CMTX_FIELD_LABEL_FORM_COOKIE', 'Store Cookie:');
define('CMTX_FIELD_LABEL_FORM_COOKIE_DAYS', 'Cookie Length:');
define('CMTX_FIELD_LABEL_ADMIN_COOKIE_DAYS', 'Admin Cookie:');
define('CMTX_FIELD_LABEL_TOPIC', 'Topic:');
define('CMTX_FIELD_LABEL_RICH_SNIPPETS_FORMAT', 'Format:');
define('CMTX_FIELD_LABEL_LIMIT', 'Limit:');
...
define('CMTX_FIELD_VALUE_SUBSCRIBER', 'email inscrito');
define('CMTX_FIELD_VALUE_SUBSCRIBERS', 'email inscritos');
...
define('CMTX_FIELD_VALUE_NO_REPORTS', 'There are currently no reports');
define('CMTX_FIELD_VALUE_ONE_REPORT', 'There is currently 1 report');
define('CMTX_FIELD_VALUE_THERE_ARE', 'There are currently');
define('CMTX_FIELD_VALUE_REPORTS', 'reports');
define('CMTX_FIELD_VALUE_SORT_BY_1', 'O mais novo');
define('CMTX_FIELD_VALUE_SORT_BY_2', 'Mais antiga');
define('CMTX_FIELD_VALUE_SORT_BY_3', 'Útil');
define('CMTX_FIELD_VALUE_SORT_BY_4', 'Controverso');
define('CMTX_FIELD_VALUE_SORT_BY_5', 'Positivo');
define('CMTX_FIELD_VALUE_SORT_BY_6', 'Crítico');
...
define('CMTX_FIELD_VALUE_REJECT', 'Erro');
...
define('CMTX_FIELD_VALUE_SPAM_DELETE_THIS', 'Apagar este.');
define('CMTX_FIELD_VALUE_SPAM_DELETE_ALL', 'Apagar tudo por esse usuário.');
define('CMTX_FIELD_VALUE_SPAM_DO_BAN', 'Proibir.');
define('CMTX_FIELD_VALUE_SPAM_NO_BAN', 'Não proibir.');
define('CMTX_FIELD_VALUE_SPAM_NAME', 'Adicione o nome, <b>%s</b>, a lista de nomes proibidos.');
define('CMTX_FIELD_VALUE_SPAM_EMAIL', 'Adicionar e-mail, <b>%s</b>, a lista proibida e-mails.');
define('CMTX_FIELD_VALUE_SPAM_WEBSITE', 'Adicionar website, <b>%s</b>, a lista de sites proibidos.');
define('CMTX_FIELD_VALUE_FRONTEND', 'Frontend');
define('CMTX_FIELD_VALUE_BACKEND', 'Backend');
define('CMTX_FIELD_VALUE_CASE_SENSITIVE', 'Case-sensitive');
define('CMTX_FIELD_VALUE_CASE_INSENSITIVE', 'Case-insensitive');
define('CMTX_FIELD_VALUE_FOUND_AT', 'Encontrado na linha de <b>%d</b> no arquivo');
define('CMTX_FIELD_VALUE_NOT_FOUND', 'Não Encontrado');
define('CMTX_FIELD_VALUE_DELAY_PAGES', 'Não crie a página até que as mensagens dos usuários.');
