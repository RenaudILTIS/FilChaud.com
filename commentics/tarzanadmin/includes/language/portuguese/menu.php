...
define('CMTX_MENU_LAYOUT_COMMENTS_READ_MORE', 'Leia Mais');
...
define('CMTX_MENU_LAYOUT_FORM_MAXIMUMS', 'Máximos');
define('CMTX_MENU_LAYOUT_FORM_ORDER', 'Ordenação');
...
define('CMTX_MENU_TITLE_SETTINGS_EMAIL_SETUP', 'Setup');
...
define('CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_USER_SUBSCRIBER_NOTIFICATION_ADMIN', 'Notificação de Inscrição (Admin)');
define('CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_USER_SUBSCRIBER_NOTIFICATION_BASIC', 'Notificação de Inscrição (Basic)');
define('CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_USER_SUBSCRIBER_NOTIFICATION_REPLY', 'Notificação de Inscrição (Reply)');
define('CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_ADMIN', 'Admin');
define('CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_ADMIN_EMAIL_TEST', 'Email Test');
...
define('CMTX_MENU_TITLE_REPORT_VIEWERS', 'Visualizadores');
...
define('CMTX_MENU_TITLE_TOOLS_TEXT_FINDER', 'Text Finder');
