...
<label class='settings_email_editor_admin_new_ban'><?php echo CMTX_FIELD_LABEL_SUBJECT; ?></label> <input type="text" required name="admin_new_ban_subject" size="35" maxlength="250" value="<?php echo cmtx_setting('admin_new_ban_subject'); ?>"/>
<p />
<label class='settings_email_editor_admin_new_ban'><?php echo CMTX_FIELD_LABEL_FROM_NAME; ?></label> <input type="text" required name="admin_new_ban_from_name" size="20" maxlength="250" value="<?php echo cmtx_setting('admin_new_ban_from_name'); ?>"/>
<p />
<label class='settings_email_editor_admin_new_ban'><?php echo CMTX_FIELD_LABEL_FROM_EMAIL; ?></label> <input type="email" required name="admin_new_ban_from_email" size="35" maxlength="250" value="<?php echo cmtx_setting('admin_new_ban_from_email'); ?>"/>
<p />
<label class='settings_email_editor_admin_new_ban'><?php echo CMTX_FIELD_LABEL_REPLY_EMAIL; ?></label> <input type="email" required name="admin_new_ban_reply_to" size="35" maxlength="250" value="<?php echo cmtx_setting('admin_new_ban_reply_to'); ?>"/>
<p /><br />
<b><?php echo CMTX_FIELD_VALUE_VARIABLES; ?></b>: <i>[ip address] [ban reasoning] [admin link] [signature]</i>
