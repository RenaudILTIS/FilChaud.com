...
$likes = $comment_result["likes"];
$dislikes = $comment_result["dislikes"];
...
?>
<p />
<label class='edit_comment'><?php echo CMTX_FIELD_LABEL_COMMENT; ?></label> <div style="margin-left:78px; width:650px"> <textarea name="comment" cols="39" rows="6"><?php echo cmtx_sanitize($comment, true, false); ?></textarea> </div>
<p />
<label class='edit_comment'><?php echo CMTX_FIELD_LABEL_ADMIN; ?></label> <div style="margin-left:78px; width:650px"> <textarea name="reply" cols="39" rows="6"><?php echo cmtx_sanitize($reply, true, false); ?></textarea> </div>
...
<?php if ($is_sticky) { ?>
<select name='is_sticky'<?php if ($reply_to) { echo " disabled='disabled'"; } ?>>
<option value='0'><?php echo CMTX_FIELD_VALUE_NO; ?></option>
<option value='1' selected='selected'><?php echo CMTX_FIELD_VALUE_YES; ?></option>
</select>
<?php } else { ?>
