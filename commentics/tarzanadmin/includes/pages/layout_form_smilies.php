...
<label class='layout_form_smilies'><img src="../images/smilies/smile.gif" title="Smile" alt="Smile"/></label> <?php if (cmtx_setting('enabled_smilies_smile')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_smile"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_smile"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/sad.gif" title="Sad" alt="Sad"/></label> <?php if (cmtx_setting('enabled_smilies_sad')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_sad"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_sad"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/huh.gif" title="Huh" alt="Huh"/></label> <?php if (cmtx_setting('enabled_smilies_huh')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_huh"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_huh"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/laugh.gif" title="Laugh" alt="Laugh"/></label> <?php if (cmtx_setting('enabled_smilies_laugh')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_laugh"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_laugh"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/mad.gif" title="Mad" alt="Mad"/></label> <?php if (cmtx_setting('enabled_smilies_mad')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_mad"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_mad"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/tongue.gif" title="Tongue" alt="Tongue"/></label> <?php if (cmtx_setting('enabled_smilies_tongue')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_tongue"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_tongue"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/crying.gif" title="Crying" alt="Crying"/></label> <?php if (cmtx_setting('enabled_smilies_crying')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_crying"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_crying"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/grin.gif" title="Grin" alt="Grin"/></label> <?php if (cmtx_setting('enabled_smilies_grin')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_grin"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_grin"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/wink.gif" title="Wink" alt="Wink"/></label> <?php if (cmtx_setting('enabled_smilies_wink')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_wink"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_wink"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/scared.gif" title="Scared" alt="Scared"/></label> <?php if (cmtx_setting('enabled_smilies_scared')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_scared"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_scared"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/cool.gif" title="Cool" alt="Cool"/></label> <?php if (cmtx_setting('enabled_smilies_cool')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_cool"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_cool"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/sleep.gif" title="Sleep" alt="Sleep"/></label> <?php if (cmtx_setting('enabled_smilies_sleep')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_sleep"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_sleep"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/blush.gif" title="Blush" alt="Blush"/></label> <?php if (cmtx_setting('enabled_smilies_blush')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_blush"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_blush"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/unsure.gif" title="Unsure" alt="Unsure"/></label> <?php if (cmtx_setting('enabled_smilies_unsure')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_unsure"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_unsure"/> <?php } ?>
<p />
<label class='layout_form_smilies'><img src="../images/smilies/shocked.gif" title="Shocked" alt="Shocked"/></label> <?php if (cmtx_setting('enabled_smilies_shocked')) { ?> <input type="checkbox" checked="checked" name="enabled_smilies_shocked"/> <?php } else { ?> <input type="checkbox" name="enabled_smilies_shocked"/> <?php } ?>
<p />
