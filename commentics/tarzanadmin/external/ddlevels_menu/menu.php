	...
	<a href="#"><?php echo CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR; ?></a>
		<ul>
			...
			<a href="#"><?php echo CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_USER; ?></a>
				...
				<?php if (!cmtx_restrict_page("settings_email_editor_user_subscriber_notification_admin")) { ?> <li><a href="index.php?page=settings_email_editor_user_subscriber_notification_admin"><?php echo CMTX_MENU_TITLE_SETTINGS_EMAIL_EDITOR_USER_SUBSCRIBER_NOTIFICATION_ADMIN; ?></a></li> <?php } ?>
