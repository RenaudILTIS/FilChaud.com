...
/* Heading */
cmtx_define('CMTX_FORM_HEADING', 'Aggiungi commento');

/* Form disabled messages */
cmtx_define('CMTX_ALL_FORMS_DISABLED', 'Non è possibile aggiungere commenti.');
cmtx_define('CMTX_THIS_FORM_DISABLED', 'Non è possibile aggiungere commenti a questa pagina.');

/* Open form link */
cmtx_define('CMTX_OPEN_FORM', 'Visualizza il modulo');
cmtx_define('CMTX_OPEN_FORM_TITLE', 'Click to open the form');

/* JavaScript disabled message */
cmtx_define('CMTX_JAVASCRIPT_DISABLED', 'JavaScript deve essere abilitato.');
...
cmtx_define('CMTX_REQUIRED_SYMBOL_MESSAGE', CMTX_REQUIRED_SYMBOL . ' Richiesto');

/* Field labels */
cmtx_define('CMTX_LABEL_NAME', 'Nome:');
cmtx_define('CMTX_LABEL_EMAIL', 'Email:');
cmtx_define('CMTX_LABEL_WEBSITE', 'Sito Web:');
cmtx_define('CMTX_LABEL_TOWN', 'Città:');
cmtx_define('CMTX_LABEL_COUNTRY', 'Nazione:');
cmtx_define('CMTX_LABEL_RATING', 'Valutazione:');
cmtx_define('CMTX_LABEL_COMMENT', 'Commento:');
cmtx_define('CMTX_LABEL_QUESTION', 'Domande:');
cmtx_define('CMTX_LABEL_CAPTCHA', 'Captcha:');

/* Field titles */
cmtx_define('CMTX_TITLE_NAME', 'Inserire il nome');
cmtx_define('CMTX_TITLE_EMAIL', 'Inserire email');
cmtx_define('CMTX_TITLE_WEBSITE', 'Inserire indirizzo web');
cmtx_define('CMTX_TITLE_TOWN', 'Inserire città');
cmtx_define('CMTX_TITLE_COMMENT', 'Inserire commento');
cmtx_define('CMTX_TITLE_QUESTION', 'Inserire la risposta alla domanda');
cmtx_define('CMTX_TITLE_NOTIFY', 'Inviami le notifiche via e-mail');
cmtx_define('CMTX_TITLE_REMEMBER', 'Ricorda i miei dati del modulo');
cmtx_define('CMTX_TITLE_PRIVACY', 'Accetto l\'informativa sulla privacy');
cmtx_define('CMTX_TITLE_TERMS', 'Accetto i termini e le condizioni');
cmtx_define('CMTX_TITLE_SUBMIT', 'Aggiungi commento');
cmtx_define('CMTX_TITLE_PREVIEW', 'Anteprima');
...
cmtx_define('CMTX_NOTE_EMAIL', '(non sarà pubblicata)');
...
cmtx_define('CMTX_TEXT_QUESTION', 'Inserire la risposta:');

/* Text displayed for Securimage captcha */
cmtx_define('CMTX_TEXT_SECURIMAGE', 'Inserisci il codice:');
cmtx_define('CMTX_TITLE_SECURIMAGE', 'Inserisci il codice visibile sull\'immagine');
...
cmtx_define('CMTX_RECAPTCHA_NO_KEY', 'API key(s) mancante nella pagina di amministrazione ReCaptcha');

/* Text displayed after notify checkbox */
cmtx_define('CMTX_TEXT_NOTIFY', 'Comunicami i nuovi commenti via e-mail.');

/* Text displayed after remember checkbox */
cmtx_define('CMTX_TEXT_REMEMBER', 'Ricordami su questo computer.');
...
cmtx_define('CMTX_SUBMIT_BUTTON', 'Aggiungi commento');

/* Text for form preview button */
cmtx_define('CMTX_PREVIEW_BUTTON', 'Anteprima');

/* Text for form buttons when processing */
cmtx_define('CMTX_PROCESSING_BUTTON', 'attendere prego..');
