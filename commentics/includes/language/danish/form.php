...
/* Heading */
cmtx_define('CMTX_FORM_HEADING', 'Tilføj kommentar');
...
/* Open form link */
cmtx_define('CMTX_OPEN_FORM', 'Åbn formular');
cmtx_define('CMTX_OPEN_FORM_TITLE', 'Click to open the form');

/* JavaScript disabled message */
cmtx_define('CMTX_JAVASCRIPT_DISABLED', 'JavaScript skal være slået til, hvis alle funktioner skal virke.');
...
cmtx_define('CMTX_REQUIRED_SYMBOL_MESSAGE', CMTX_REQUIRED_SYMBOL . ' Skal udfyldes');

/* Field labels */
cmtx_define('CMTX_LABEL_NAME', 'Navn:');
cmtx_define('CMTX_LABEL_EMAIL', 'Mailadresse:');
cmtx_define('CMTX_LABEL_WEBSITE', 'Hjemmeside:');
cmtx_define('CMTX_LABEL_TOWN', 'By:');
cmtx_define('CMTX_LABEL_COUNTRY', 'Land:');
cmtx_define('CMTX_LABEL_RATING', 'Karakter:');
cmtx_define('CMTX_LABEL_COMMENT', 'Kommentar:');
cmtx_define('CMTX_LABEL_QUESTION', 'Spamfælde:');
cmtx_define('CMTX_LABEL_CAPTCHA', 'Captcha:');

/* Field titles */
cmtx_define('CMTX_TITLE_NAME', 'Indtast navn');
cmtx_define('CMTX_TITLE_EMAIL', 'Indtast mailadresse');
cmtx_define('CMTX_TITLE_WEBSITE', 'Indtast adresse til hjemmeside');
cmtx_define('CMTX_TITLE_TOWN', 'Indtast by');
cmtx_define('CMTX_TITLE_COMMENT', 'Indtast kommentar');
cmtx_define('CMTX_TITLE_QUESTION', 'Indtast svar på spørgsmålet');
cmtx_define('CMTX_TITLE_NOTIFY', 'Modtag besked via mail');
cmtx_define('CMTX_TITLE_REMEMBER', 'Husk mine formulardata');
cmtx_define('CMTX_TITLE_PRIVACY', 'Accepter privatslivspolitikken');
cmtx_define('CMTX_TITLE_TERMS', 'Accepter betingelserne');
cmtx_define('CMTX_TITLE_SUBMIT', 'Tilføj kommentar');
cmtx_define('CMTX_TITLE_PREVIEW', 'Smugkig');
...
cmtx_define('CMTX_NOTE_EMAIL', '(offentliggøres ikke)');
...
cmtx_define('CMTX_TEXT_QUESTION', 'Indtast svar:');
...
cmtx_define('CMTX_TEXT_NOTIFY', 'Giv mig besked via mail om nye kommentarer.');

/* Text displayed after remember checkbox */
cmtx_define('CMTX_TEXT_REMEMBER', 'Husk mine formulardata på denne computer');
...
cmtx_define('CMTX_SUBMIT_BUTTON', 'Tilføj kommentar');

/* Text for form preview button */
cmtx_define('CMTX_PREVIEW_BUTTON', 'Smugkig');

/* Text for form buttons when processing */
cmtx_define('CMTX_PROCESSING_BUTTON', 'Vent..');
