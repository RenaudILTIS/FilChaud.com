...
cmtx_define('CMTX_ALL_FORMS_DISABLED', 'Dodavanje komentara je onemogućeno.');
cmtx_define('CMTX_THIS_FORM_DISABLED', 'Dodavanje komentara je onemogućeno za ovu stranicu.');

/* Open form link */
cmtx_define('CMTX_OPEN_FORM', 'Prikaz obrasca');
cmtx_define('CMTX_OPEN_FORM_TITLE', 'Click to open the form');

/* JavaScript disabled message */
cmtx_define('CMTX_JAVASCRIPT_DISABLED', 'Upozorenje: neke usluge dostupne su samo uz uključen JavaScript.');
...
cmtx_define('CMTX_REQUIRED_SYMBOL_MESSAGE', CMTX_REQUIRED_SYMBOL . ' Potrebne informacije');

/* Field labels */
cmtx_define('CMTX_LABEL_NAME', 'Naziv:');
cmtx_define('CMTX_LABEL_EMAIL', 'E-mail:');
cmtx_define('CMTX_LABEL_WEBSITE', 'Web:');
cmtx_define('CMTX_LABEL_TOWN', 'Grad:');
cmtx_define('CMTX_LABEL_COUNTRY', 'Država:');
cmtx_define('CMTX_LABEL_RATING', 'Ocjena:');
cmtx_define('CMTX_LABEL_COMMENT', 'Komentar:');
cmtx_define('CMTX_LABEL_QUESTION', 'Pitanje:');
cmtx_define('CMTX_LABEL_CAPTCHA', 'Captcha:');

/* Field titles */
cmtx_define('CMTX_TITLE_NAME', 'Unesite ime');
cmtx_define('CMTX_TITLE_EMAIL', 'Unesite adresu e-pošte');
cmtx_define('CMTX_TITLE_WEBSITE', 'Unesite web stranicu');
cmtx_define('CMTX_TITLE_TOWN', 'Unesite grad');
cmtx_define('CMTX_TITLE_COMMENT', 'Unesite komentar');
cmtx_define('CMTX_TITLE_QUESTION', 'Unesite odgovor na pitanje');
cmtx_define('CMTX_TITLE_NOTIFY', 'Želim primati e-mail obavjesti');
cmtx_define('CMTX_TITLE_REMEMBER', 'Sjeti se moje ulaza obrasca');
cmtx_define('CMTX_TITLE_PRIVACY', 'Prihvaćam pravila o privatnosti');
cmtx_define('CMTX_TITLE_TERMS', 'Slažem se s uvjetima korištenja');
cmtx_define('CMTX_TITLE_SUBMIT', 'Dodajte komentar');
cmtx_define('CMTX_TITLE_PREVIEW', 'Pregled');
...
cmtx_define('CMTX_NOTE_EMAIL', '(neće biti objavljeno)');
...
cmtx_define('CMTX_TEXT_QUESTION', 'Unesite odgovor:');
