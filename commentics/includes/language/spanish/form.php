...
/* Heading */
cmtx_define('CMTX_FORM_HEADING', 'Agregar Comentario');

/* Form disabled messages */
cmtx_define('CMTX_ALL_FORMS_DISABLED', 'No se pueden añadir comentarios.');
cmtx_define('CMTX_THIS_FORM_DISABLED', 'No se pueden añadir comentarios a esta página.');

/* Open form link */
cmtx_define('CMTX_OPEN_FORM', 'Mostrar el formulario');
cmtx_define('CMTX_OPEN_FORM_TITLE', 'Click to open the form');

/* JavaScript disabled message */
cmtx_define('CMTX_JAVASCRIPT_DISABLED', 'JavaScript debe estar habilitado.');

/* Reply */
cmtx_define('CMTX_REPLY_MESSAGE', 'está respondiendo a ');
cmtx_define('CMTX_REPLY_CANCEL', '[cancelar]');
cmtx_define('CMTX_REPLY_CANCEL_TITLE', 'Cancel this reply');
cmtx_define('CMTX_REPLY_NOBODY', 'No está respondiendo a nadie.');

/* Required */
cmtx_define('CMTX_REQUIRED_SYMBOL', '*');
cmtx_define('CMTX_REQUIRED_SYMBOL_MESSAGE', CMTX_REQUIRED_SYMBOL . ' Información requerida');

/* Field labels */
cmtx_define('CMTX_LABEL_NAME', 'Nombre:');
cmtx_define('CMTX_LABEL_EMAIL', 'Email:');
cmtx_define('CMTX_LABEL_WEBSITE', 'Web:');
cmtx_define('CMTX_LABEL_TOWN', 'Ciudad:');
cmtx_define('CMTX_LABEL_COUNTRY', 'País:');
cmtx_define('CMTX_LABEL_RATING', 'Valoración:');
cmtx_define('CMTX_LABEL_COMMENT', 'Comentario:');
cmtx_define('CMTX_LABEL_QUESTION', 'Pregunta:');
cmtx_define('CMTX_LABEL_CAPTCHA', 'Captcha:');

/* Field titles */
cmtx_define('CMTX_TITLE_NAME', 'Introducir nombre');
cmtx_define('CMTX_TITLE_EMAIL', 'Introducir email');
cmtx_define('CMTX_TITLE_WEBSITE', 'Introducir Web');
cmtx_define('CMTX_TITLE_TOWN', 'Introducir ciudad');
cmtx_define('CMTX_TITLE_COMMENT', 'Introducir comentario');
cmtx_define('CMTX_TITLE_QUESTION', 'Introducir respuesta a la pregunta');
cmtx_define('CMTX_TITLE_NOTIFY', 'recibir notificaciones por Email');
cmtx_define('CMTX_TITLE_REMEMBER', 'Recuerde mis formularios de entrada');
cmtx_define('CMTX_TITLE_PRIVACY', 'Estoy de acuerdo con la política de privacidad');
cmtx_define('CMTX_TITLE_TERMS', 'Estoy de acuerdo con los términos y condiciones');
cmtx_define('CMTX_TITLE_SUBMIT', 'añadir comentario');
cmtx_define('CMTX_TITLE_PREVIEW', 'Vista previa');
...
cmtx_define('CMTX_NOTE_EMAIL', '(no será publicado)');
...
cmtx_define('CMTX_TEXT_QUESTION', 'Introduzca la respuesta:');
...
cmtx_define('CMTX_TEXT_NOTIFY', 'Informarme de los nuevos comentarios por Email.');

/* Text displayed after remember checkbox */
cmtx_define('CMTX_TEXT_REMEMBER', 'Recordar mis datos en este equipo.');
...
cmtx_define('CMTX_SUBMIT_BUTTON', ' Enviar ');

/* Text for form preview button */
cmtx_define('CMTX_PREVIEW_BUTTON', 'Vista previa');

/* Text for form buttons when processing */
cmtx_define('CMTX_PROCESSING_BUTTON', 'Por favor, espere..');
