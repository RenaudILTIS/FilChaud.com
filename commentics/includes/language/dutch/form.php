...
/* Heading */
cmtx_define('CMTX_FORM_HEADING', 'Commentaar Toevoegen');

/* Form disabled messages */
cmtx_define('CMTX_ALL_FORMS_DISABLED', 'Berichten toevoegen is uitgeschakeld.');
cmtx_define('CMTX_THIS_FORM_DISABLED', 'Berichten toevoegen is uitgeschakeld voor deze pagina.');

/* Open form link */
cmtx_define('CMTX_OPEN_FORM', 'Geef het formulier');
cmtx_define('CMTX_OPEN_FORM_TITLE', 'Click to open the form');

/* JavaScript disabled message */
cmtx_define('CMTX_JAVASCRIPT_DISABLED', 'JavaScript moet zijn ingeschakeld voor sommige opties om te werken.');
...
cmtx_define('CMTX_REQUIRED_SYMBOL_MESSAGE', CMTX_REQUIRED_SYMBOL . ' Verplichte informatie');

/* Field labels */
cmtx_define('CMTX_LABEL_NAME', 'Naam:');
cmtx_define('CMTX_LABEL_EMAIL', 'Email:');
cmtx_define('CMTX_LABEL_WEBSITE', 'Website:');
cmtx_define('CMTX_LABEL_TOWN', 'Stad:');
cmtx_define('CMTX_LABEL_COUNTRY', 'Land:');
cmtx_define('CMTX_LABEL_RATING', 'Waardering:');
cmtx_define('CMTX_LABEL_COMMENT', 'Bericht:');
cmtx_define('CMTX_LABEL_QUESTION', 'Vraag:');
cmtx_define('CMTX_LABEL_CAPTCHA', 'Captcha:');

/* Field titles */
cmtx_define('CMTX_TITLE_NAME', 'Voer naam in');
cmtx_define('CMTX_TITLE_EMAIL', 'Voer emailadres in');
cmtx_define('CMTX_TITLE_WEBSITE', 'Voer uw website in');
cmtx_define('CMTX_TITLE_TOWN', 'Voer stad in');
cmtx_define('CMTX_TITLE_COMMENT', 'Voer bericht in');
cmtx_define('CMTX_TITLE_QUESTION', 'Voer antwoord op vraag in');
cmtx_define('CMTX_TITLE_NOTIFY', 'Ontvang email berichten');
cmtx_define('CMTX_TITLE_REMEMBER', 'Onthoud mijn vorm ingangen');
cmtx_define('CMTX_TITLE_PRIVACY', 'Akkoord met privacy policy');
cmtx_define('CMTX_TITLE_TERMS', 'Akkoord met voorwaarden');
cmtx_define('CMTX_TITLE_SUBMIT', 'Voeg bericht toe');
cmtx_define('CMTX_TITLE_PREVIEW', 'Voorbeeld');
...
cmtx_define('CMTX_NOTE_EMAIL', '(wordt niet getoond)');
...
cmtx_define('CMTX_TEXT_QUESTION', 'Voer antwoord in:');

/* Text displayed for Securimage captcha */
cmtx_define('CMTX_TEXT_SECURIMAGE', 'Geef decode in:');
cmtx_define('CMTX_TITLE_SECURIMAGE', 'Geef de code van de afbeelding in');
cmtx_define('CMTX_TITLE_SECURIMAGE_AUDIO', 'Audio');
cmtx_define('CMTX_TITLE_SECURIMAGE_REFRESH', 'Ververs');

/* Text displayed if ReCaptcha key missing */
cmtx_define('CMTX_RECAPTCHA_NO_KEY', 'API-sleutel(s) ontbreekt in de ReCaptcha admin pagina.');

/* Text displayed after notify checkbox */
cmtx_define('CMTX_TEXT_NOTIFY', 'Meld me over nieuwe berichten via email.');

/* Text displayed after remember checkbox */
cmtx_define('CMTX_TEXT_REMEMBER', 'Onthoud mijn gegevens op deze computer.');
...
cmtx_define('CMTX_SUBMIT_BUTTON', 'Voeg bericht toe');

/* Text for form preview button */
cmtx_define('CMTX_PREVIEW_BUTTON', 'Voorbeeld');

/* Text for form buttons when processing */
cmtx_define('CMTX_PROCESSING_BUTTON', 'Aub wachten..');
...
cmtx_define('CMTX_POWERED_BY', 'Aangedreven door');
